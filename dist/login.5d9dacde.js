...
window.login = function login() {
    ...
    axios.get("http://localhost:3000/user").then(function(response) {
        ...
        if (uID == "") alert("You wasn't insert Your ID. Please inset your ID. If you don't have an account, press Signup");
        else {
            if (uPW == "") alert("Please type your password!!!");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iSP81","1Z4Rq"], "1Z4Rq", "parcelRequire94c2")

//# sourceMappingURL=login.5d9dacde.js.map
